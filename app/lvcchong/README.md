...
- **登录方式全不可脚本化**:App 仅「短信验证码 / Apple ID / SIM 一键登录」三种,无账号密码登录,均无法脚本重登。配合 20 分钟 token,彻底无解

## 维护记录

| 日期 | 变更 |
|---|---|
| 2026-06-02 | 初版,refreshToken 续命签到 |
| 2026-06-03 | 实测 refreshToken 空闲仅 ~20 分钟,无法定时续命 → 📦 归档 |
| 2026-06-03 | 复核:三种登录全不可脚本化,定论无解 |
